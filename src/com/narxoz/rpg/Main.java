...
public class Main {
    public static void main(String[] args) {
        ...
        ArenaFighter hero = new ArenaFighter("Cleric", 110, 0.22, 24, 6, 17, 4);

        ArenaOpponent opponent = new ArenaOpponent("DuPont(Father)", 95, 16);
        ...
        ArenaFighter tournamentHero     = new ArenaFighter("Cleric",    130, 0.24, 27, 8, 24, 4);
        ArenaOpponent tournamentOpponent = new ArenaOpponent("DuPont(Father)", 110, 27);
